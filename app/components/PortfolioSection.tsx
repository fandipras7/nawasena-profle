...
export default function PortfolioSection({
  ...
  projects = [
    ...
    },
    {
      ...
      tag: "Android + Web",
      img: "/images/porto-ipcs.png",
      desc: "Smart matching between trucks & containers plus trip tracking.",
      link: "#contact",
    },
  ],
  partners = [
    { name: "Avter", logo: "/images/logo-partner-avter.png", href: "#" },
    { name: "Aerozeta", logo: "/images/logo-partner-aerozeta.png", href: "#" },
    { name: "Iotace", logo: "/images/logo-partner-iotace.png", href: "#" },
    { name: "IPCS", logo: "/images/logo-partner-ipcs.png", href: "#" },
    { name: "SAG", logo: "/images/logo-partner-sag.png", href: "#" },
  ],
